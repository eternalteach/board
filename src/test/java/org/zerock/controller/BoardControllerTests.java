...
@WebAppConfiguration // Servlet의 ServletContext를 이용하기 위해서 작성했다.
...
public class BoardControllerTests {
	...
	private MockMvc mockMvc; // 가짜 Mvc라 생각하면된다. 가짜로 URL과 파라미터 등을 브라우저에서 사용하는 것 처럼 만들어서 Controller을 실행해 볼 수 있다.
